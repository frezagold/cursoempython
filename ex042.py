...
if a < b + c and b < a + c and c < a + b:
    print('\033[0;32mO segmento acima podem formar um triângulo!\033[0;32m', end='')
    if a == b == c:
        print('\033[0;32mEQUILÁTERO!\033[0;32m')
    elif a != b != c != a:
        print('\033[0;32mESCALENO!\033[0;32m')
    else:
        print('\033[0;32mISÓSCELES!\033[0;32m')
else:
